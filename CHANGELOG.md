...
- [v0.8.0](changelog/v0.8.0.md) - v1/v2 split + v0.8.x roadmap (compiler/ → v1/, v2/ skeleton mirroring CPython Python/*.c, CI oracle warn-only, specs 1575 + 1576) (2026-04-30)
- [v0.7.10.12](changelog/v0.7.10.12.md) - while + for + nested-def + nonlocal in funcbody (4 fixtures); LocalsPlus locals-before-cells slot ordering; resolveNameOp cell/free wins over local; closure tuple LOAD_FAST for cells / LOAD_DEREF for frees; MAKE_CELL+COPY_FREE_VARS prologue (2026-04-30)
